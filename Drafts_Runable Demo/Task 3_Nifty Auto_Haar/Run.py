...
# ==============================
"""
Objective: Forecast NIFTY AUTO index closing prices for Apr 2025 – Sep 2025
...
# ==============================
# Load datasets
train1 = pd.read_csv("NIFTY_AUTO_Historical_PR_01042023to31032024.csv")
train2 = pd.read_csv("NIFTY_AUTO_Historical_PR_01042024to31032025.csv") 
test = pd.read_csv("NIFTY_AUTO_Historical_PR_01042025to31102025.csv")
...
# Save to CSV
predictions_df.to_csv('NIFTY_AUTO_Forecast_Predictions.csv', index=False)
print("Predictions saved to 'NIFTY_AUTO_Forecast_Predictions.csv'")
